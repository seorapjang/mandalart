...
export default function Toolbar({
  ...
  return (
    <div className="flex flex-wrap gap-2 justify-center">
      ...
      <button onClick={onOpenSavedList} className={secondaryBtn}>
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button onClick={onExportPng} className={primaryBtn}>
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button onClick={onCopyToClipboard} className={primaryBtn}>
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button onClick={onSelectTemplate} className={primaryBtn}>
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button onClick={onOpenGuide} className={primaryBtn}>
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
