        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          <div className="text-center bg-amber-50 p-4 rounded-lg">
            <p className="text-gray-700 font-medium">
              ...
              <span className="text-amber-700 font-bold">'삶을 어떻게 바꿀지'</span>를 정리하는 도구입니다.
            </p>
          ...
          {/* STEP 1 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 1. 가운데 목표부터 정하세요</h3>
          ...
          {/* STEP 2 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 2. 이 목표를 위해 어떤 삶이 필요한지 생각해요</h3>
          ...
          {/* STEP 3 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 3. 주변 칸은 '연결된 것'만 적어요</h3>
            <p className="text-gray-700 mb-3">
              주변 칸은 하고 싶은 일을 나열하는 곳이 아닙니다.<br />
              <strong>가운데 목표에 실제로 도움이 되는 것만</strong> 적습니다.
            </p>
            <div className="bg-amber-50 p-3 rounded-lg mb-3">
              <p className="text-amber-700 font-medium">🎯 예시 - 가운데 목표: <em>에세이를 더 재밌게 쓰기</em></p>
            </div>
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="bg-green-50 p-3 rounded-lg">
          ...
          {/* STEP 4 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 4. 전부 채우지 않아도 괜찮아요</h3>
            ...
            <div className="bg-purple-50 p-3 rounded-lg text-purple-800 italic">
          ...
          {/* STEP 5 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 5. 시간 계획이 없으면 실행되지 않아요</h3>
          ...
          {/* STEP 6 */}
          <section>
            <h3 className="text-lg font-bold text-amber-600 mb-3">STEP 6. 욕심내지 말고, 느슨하게 가세요</h3>
